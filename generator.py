...
def gen_spk_garantiynoe(num, name, company, dates, resp, api_key):
    ...
    contents = {
        ...
        3: f"гарантирует своевременное заключение договоров с аккредитованными лабораториями на проведение испытаний строительных материалов и изделий, применяемых при выполнении работ в области: {company.get('scope','')}.",
