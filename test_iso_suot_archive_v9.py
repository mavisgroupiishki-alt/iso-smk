"""Regression tests for ISO/SUOT archive extraction v9.

Run from the project root:
    python test_iso_suot_archive_v9.py
"""
...
spec = importlib.util.spec_from_file_location("iso_server_v9", ROOT / "server.py")
